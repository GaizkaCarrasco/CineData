...
arquitectura = [
    "🏗️ TIPO DE ARQUITECTURA: MICROSERVICIOS",
    ...
    "",
    "🔧 STACK TECNOLÓGICO:",
    "  Backend 1: FastAPI + Motor (async MongoDB driver) en Python",
    ...
    "  • HTML5 con uso extensivo de JavaScript/JSX",
    "  • NO multipage, NO PWA, NO subida a la nube",
    "",
    "🔌 INTEGRACIÓN:",
    "  • NO hay API Gateway (comunicación directa cliente-servidor)",
    "  • Múltiples endpoints en diferentes puertos",
...
lecciones = [
    ...
    "  • Orquestación compleja con Docker Compose",
    ...
    "  • CORS configurado en ambos backends para seguridad",
    ...
    "  ✅ Sistema COMPLETO y FUNCIONAL (Full-Stack)",
    "  ✅ Arquitectura PROFESIONAL con separación de responsabilidades",
    "  ✅ SEGURIDAD implementada en múltiples niveles",
    "  ✅ Uso de BUENAS PRÁCTICAS y patrones de diseño",
    "  ✅ ESCALABLE y MANTENIBLE para futuros cambios",
